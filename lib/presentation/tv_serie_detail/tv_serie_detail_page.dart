...
class TvSerieDetailPage extends StatefulWidget {
  ...
  final int id;
  TvSerieDetailPage({required this.id});

  @override
  _TvSerieDetailPageState createState() => _TvSerieDetailPageState();
}

class _TvSerieDetailPageState extends State<TvSerieDetailPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
...
class DetailContent extends StatelessWidget {
  final TvSerieDetail data;
  final List<TvSerie> recommendations;
